...
define("AGILE_DOMAIN", "jecompareimmo");  # Example : define("domain","jim");
define("AGILE_USER_EMAIL", "contact@jecompare.immo");
define("AGILE_REST_API_KEY", "luki8qv17a2ribt02t9e2etlam");
